...
public class SqlParserTest {
    ...
    @Test public void testSqlOptions() throws SqlParseException {
        SqlNode node = new SqlParser("alter system set schema = true").parseStmt();
        SqlOptionSetter opt = (SqlOptionSetter) node;
        assert opt.getScope().equalsIgnoreCase("system") : "scope parsed incorrectly in option set statement.";
        assert opt.getName().equalsIgnoreCase("schema") : "option name parsed incorrectly in option set statement.";
